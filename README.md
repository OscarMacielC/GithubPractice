...
> Soy \[Oscar Maciel Castillo\] y edité este archivo.
...
¿Qué sucede si hay un cambio hecho en GitHub que no está presente en tu repositorio local? Esta es una situación común cuando se colabora o si trabajas en distintas máquinas. Tu compañero hizo una cambio en el código que

> Soy \[Oscar\] y edité este archivo desde GitHub web.
